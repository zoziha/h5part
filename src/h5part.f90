...
module h5part_m
    ...
    !> Write attribute to H5part file <br>
    !> 写入属性到H5part文件
    ...
    !> Read attribute from H5part file <br>
    !> 读取属性从H5part文件
    ...
    !> Write an attribute to timestep <br>
    !> 写入属性到时间步
    ...
    !> Read attribute from timestep <br>
    !> 读取属性从时间步
    ...
    interface
        include "../h5part/inc/H5Block.f90"
        include "../h5part/inc/H5BlockReadWrite.f90"
