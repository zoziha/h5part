...
INTEGER*8 FUNCTION h5pt_writefileattrib_string(filehandle, attrib_name, attrib_value)
    ...
    CHARACTER(LEN=*), INTENT(IN) :: attrib_value       !< the string value to store
END FUNCTION
...
INTEGER*8 FUNCTION h5pt_readfileattrib_string(filehandle, attrib_name, attrib_value)
    INTEGER*8, INTENT(IN) :: filehandle         !< the handle returned during file open
    CHARACTER(LEN=*), INTENT(IN) :: attrib_name        !< the name of the attribute
    CHARACTER(LEN=*), INTENT(OUT) :: attrib_value      !< buffer to read the string value into
END FUNCTION
...
INTEGER*8 FUNCTION h5pt_getstepattribinfo(filehandle, idx, attrib_name, attrib_nelem)
    ...
    CHARACTER(LEN=*), INTENT(OUT) :: attrib_name       !< buffer to read the attribute name into
    INTEGER*8, INTENT(OUT) :: attrib_nelem             !< number of elements in the attribute's array
END FUNCTION
