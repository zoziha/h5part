...
!! \return 0 on success or error code
!>
INTEGER(8) FUNCTION h5pt_writefileattrib_r4(filehandle, attrib_name, attrib_value, attrib_nelem)
    INTEGER(8), INTENT(IN) :: filehandle         !< the handle returned at file open
    CHARACTER(LEN=*), INTENT(IN) :: attrib_name !< the name of the attribute
...
!! \return 0 on success or error code
!>
INTEGER(8) FUNCTION h5pt_writefileattrib_i4(filehandle, attrib_name, attrib_value, attrib_nelem)
    INTEGER(8), INTENT(IN) :: filehandle         !< the handle returned at file open
    CHARACTER(LEN=*), INTENT(IN) :: attrib_name !< the name of the attribute
...
!! \return 0 on success or error code
!>
INTEGER(8) FUNCTION h5pt_writestepattrib_r4(filehandle, attrib_name, attrib_value, attrib_nelem)
    INTEGER(8), INTENT(IN) :: filehandle     !< the handle returned at file open
    CHARACTER(LEN=*), INTENT(IN) :: attrib_name !< the name of the attribute
    REAL(4), INTENT(IN) :: attrib_value(*)   !< the array of data to write into the attribute
    INTEGER(8), INTENT(IN) :: attrib_nelem   !< the number of elements in the array
...
!! \return 0 on success or error code
!>
INTEGER(8) FUNCTION h5pt_writestepattrib_i4(filehandle, attrib_name, attrib_value, attrib_nelem)
    INTEGER(8), INTENT(IN) :: filehandle         !< the handle returned at file open
    CHARACTER(LEN=*), INTENT(IN) :: attrib_name !< the name of the attribute
    INTEGER(4), INTENT(IN) :: attrib_value(*)    !< the array of data to write into the attribute
    INTEGER(8), INTENT(IN) :: attrib_nelem       !< the number of elements in the array
